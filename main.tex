...
Trần Ngọc Mỹ Trinh & 25127258 & Huffman Coding, Deflate (Huffman Token Coder), CLI \& BitStream I/O, Report Lead & 33.3\% \\ \hline
Lý Sĩ Vĩ & 24127587 & RLE Algorithm, Deflate (LZ77 Sliding Matcher), Benchmark Suite, Experiments & 33.3\% \\ \hline
Từ Nguyễn Thuận Thiên & 25127146 & LZW Algorithm, Deflate (LZ77 Reconstructor), Bit-packing, Demo, Readme & 33.3\% \\ \hline
\end{tabularx}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Efficiency Comparison}: Naive pair RLE would emit $[1,'B', 1,'A', 2,'B', 1,'A', 1,'C', 1,'A', 1,'C'] \to \mathbf{14\text{ bytes}}$ (+75\% expansion). PackBits limits expansion overhead to only 1 control byte (+12.5\%).
\end{itemize}
...
\begin{table}[H]
\centering
\caption{Comprehensive Experimental Benchmark Results (Table 1)}
\label{tab:benchmarks}
\renewcommand{\arraystretch}{1.15}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|r|l|r|r|r|r|r|r|}
\hline
\textbf{Scenario} & \textbf{Size} & \textbf{Data Type} & \textbf{RLE Ratio} & \textbf{Huffman Ratio} & \textbf{Deflate Ratio} & \textbf{RLE (ms)} & \textbf{Huff (ms)} & \textbf{Defl (ms)} \\ \hline
Scenario 1 & 10 KB & English Prose & $0.99\times$ (-0.9\%) & $1.67\times$ (40.1\%) & $\mathbf{8.80\times}$ (88.6\%) & 0.29 & 0.49 & 0.41 \\ \hline
Scenario 1 & 50 KB & English Prose & $0.99\times$ (-0.8\%) & $1.76\times$ (43.0\%) & $\mathbf{28.13\times}$ (96.4\%) & 0.44 & 0.87 & 0.53 \\ \hline
Scenario 1 & 100 KB & English Prose & $0.99\times$ (-0.8\%) & $1.77\times$ (43.4\%) & $\mathbf{38.77\times}$ (97.4\%) & 0.56 & 1.31 & 0.61 \\ \hline
Scenario 1 & 500 KB & English Prose & $0.99\times$ (-0.8\%) & $1.78\times$ (43.7\%) & $\mathbf{55.72\times}$ (98.2\%) & 1.67 & 4.67 & 1.65 \\ \hline
Scenario 1 & 1 MB & English Prose & $0.99\times$ (-0.8\%) & $1.78\times$ (43.7\%) & $\mathbf{59.01\times}$ (98.3\%) & 3.47 & 9.03 & 3.35 \\ \hline
Scenario 1 & 5 MB & English Prose & $0.99\times$ (-0.8\%) & $1.78\times$ (43.8\%) & $\mathbf{61.81\times}$ (98.4\%) & 16.11 & 46.74 & 14.54 \\ \hline
Scenario 1 & 10 MB & English Prose & $0.99\times$ (-0.8\%) & $1.78\times$ (43.8\%) & $\mathbf{62.17\times}$ (98.4\%) & 31.58 & 125.27 & 25.19 \\ \hline
Scenario 2 & 1 MB & Highly Repetitive & $2.12\times$ (52.9\%) & $2.38\times$ (58.1\%) & $\mathbf{61.82\times}$ (98.4\%) & 2.35 & 7.18 & 4.12 \\ \hline
Scenario 2 & 1 MB & English Prose & $0.99\times$ (-0.8\%) & $1.78\times$ (43.7\%) & $\mathbf{59.01\times}$ (98.3\%) & 3.46 & 10.19 & 3.15 \\ \hline
Scenario 2 & 1 MB & Random Binary & $0.99\times$ (-0.8\%) & $1.00\times$ (-0.2\%) & $0.89\times$ (-12.7\%) & 3.63 & 14.54 & 30.55 \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{itemize}
    \item \textbf{On Natural English Prose}: \textbf{DEFLATE} achieved the highest compression ratio by a vast margin ($\mathbf{62.17\times}$ at 10\,MB, 98.4\% space savings), followed by \textbf{Huffman Coding} ($1.78\times$, 43.8\% savings). \textbf{RLE} produced no compression ($0.99\times$).
    \item \textbf{On Highly Repetitive Data}: \textbf{DEFLATE} led at $\mathbf{61.82\times}$ (98.4\%), while both \textbf{Huffman} ($2.38\times$) and \textbf{RLE} ($2.12\times$) delivered solid space savings ($> 52\%$).
    \item \textbf{On Random Binary Data}: All algorithms experienced slight expansion or zero compression due to maximum entropy ($H \approx 8.0\text{ bits/byte}$).
\end{itemize}
